...
const Sidebar = () => {
  ...
  return (
    <div className="flex">
      {/* Sidebar */}
      <div
        className={`w-64 bg-gray-800 h-screen transition-all duration-300 transform ${
      ...
      >
        ...
        <div className="flex fixed top-5 left-5 z-10 items-center justify-around cursor-pointer">
          ...
          {isOpen && (
            <div className="p-3 ml-5 flex items-center justify-between w-[140px] rounded-md bg-primary">
              <AiOutlinePlus />
