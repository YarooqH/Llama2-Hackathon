    ...
    return (
        <>
            ...
            <div className={`flex transition-all duration-300 ${isOpen ? 'fixed' : 'fixed'}  `}>
                ...
                {/* Sidebar */}
                {<div
                    className={`w-64 bg-base-100 border-r-2 border-accent h-screen transition-all duration-300 transform ${isOpen ? 'translate-x-0' : '-translate-x-64 w-0'
                        }`}
                >
                ...
                <div className={`transition-all duration-300`} >
                    ...
                    <div className='flex fixed top-3 left-3 z-10 items-center justify-around cursor-pointer'>
                        ...
                        {isOpen && <div className='p-3 ml-5 flex items-center justify-between w-[140px] rounded-md bg-primary transition-all duration-300 hover:scale-105'>
